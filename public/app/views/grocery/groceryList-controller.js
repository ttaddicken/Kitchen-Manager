app.controller('GroceryController', function($rootScope, $scope, DishService, CONSTANTS, $firebaseArray, item) {
    ...
    $scope.acceptChanges = function(item){
        item.totalCost = item.unitsbuying * item.price;   
        $scope.items.$save(item)
    }
